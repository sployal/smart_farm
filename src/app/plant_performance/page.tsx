...
function PlantAnimation({ status, moisture, health }: {
  ...
  // Leaf droop angle based on health
  ...
  return (
    <div className="relative flex items-end justify-center w-full h-full">
      ...
      >
        ...
        {/* Moisture water indicator in pot */}
        <rect
        ...
        <path
          d={droopy
            ? "M 99 145 C 85 138 75 128 62 118"
            : "M 100 148 C 86 140 76 128 65 115"}
          stroke="url(#stemGrad)"
          strokeWidth="3.5"
          fill="none"
          strokeLinecap="round"
        ...
        <path
          d={droopy
            ? "M 99 130 C 113 122 123 112 136 105"
            : "M 100 132 C 114 124 124 112 137 98"}
          stroke="url(#stemGrad)"
          strokeWidth="3.5"
          fill="none"
          strokeLinecap="round"
        ...
        <g transform={`translate(100, 78) rotate(${droop * 0.5}, 0, 0)`}>
          {/* Center big leaf */}
          <ellipse cx="0" cy="-18" rx="16" ry="22"
            fill={color}
            opacity={wilted ? 0.35 : 0.95}
            className="transition-all duration-1000"
          />
          {/* Left top leaf */}
          <ellipse cx="-16" cy="-22" rx="12" ry="16"
            fill={color}
            opacity={wilted ? 0.3 : 0.85}
            transform="rotate(-20)"
            className="transition-all duration-1000"
          />
          {/* Right top leaf */}
        ...
        {/* Breathing animation on top leaf */}
        {!wilted && (
...
export default function PlantPerformancePage() {
  ...
  const healthScore = Math.round(
    (radarData.reduce((acc, d) => acc + d.A, 0) / radarData.length)
  );
  ...
  return (
    <div className="min-h-screen text-slate-100 font-sans" style={{ background: '#1a2332' }}>
      ...
      <div className="relative z-10 p-4 sm:p-6 lg:p-8 max-w-[1400px] mx-auto space-y-6">
        ...
        {/* ── Top grid: Plant + Status Card + Metrics ── */}
            ...
            <div className="px-5 pb-5 pt-3 space-y-2">
              ...
              <div className="h-2 rounded-full overflow-hidden" style={{ background: '#3a4556' }}>
                <div
                  className="h-full rounded-full transition-all duration-1000"
                  style={{
                    width: `${Math.min(100, (sensorData.temperature / 40) * 100)}%`,
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <h2 className="text-lg font-black text-slate-100 leading-tight mb-1">
                        {aiReport.headline}
                      </h2>
                  ...
                  <div className="space-y-2">
                    ...
                    {aiReport.actions.map((action, i) => (
                      ...
                      >
                        <span className="w-5 h-5 rounded-full flex items-center justify-center text-[10px] font-bold bg-white/10 flex-shrink-0">
                          {i + 1}
                        </span>
                        {action.text}
            ...
            <div className="h-64">
              <ResponsiveContainer width="100%" height="100%">
                <AreaChart data={timeline}>
                  ...
                  <Tooltip
                    contentStyle={{ background: '#1e293b', border: '1px solid #334155', borderRadius: 10, color: '#f1f5f9', fontSize: 12 }}
